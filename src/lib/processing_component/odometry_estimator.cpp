...
OdometryEstimator::OdometryEstimator(const Parameter parameter)
  : ProcessingComponent("odometry_estimator")
{
  (void)parameter;
}
...
nav_msgs::Odometry OdometryEstimator::getOdometryMessage(const std::string& robot_base_frame, const std::string& odom_frame) const
{
...
geometry_msgs::TransformStamped OdometryEstimator::getTfMessage(const std::string& robot_base_frame, const std::string& odom_frame) const
{
